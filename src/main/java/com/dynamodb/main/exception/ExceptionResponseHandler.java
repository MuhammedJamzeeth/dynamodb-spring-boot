...
public class ExceptionResponseHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(@NonNull MethodArgumentNotValidException exception,
		...
		final var description = fieldErrors.stream().map(DefaultMessageSourceResolvable::getDefaultMessage).collect(Collectors.toList());
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(@NonNull HttpMessageNotReadableException exception,
		...
		exceptionResponse.setStatus(HttpStatus.BAD_REQUEST.toString());
		final var description = new AtomicReference<>(NOT_READABLE_REQUEST_ERROR_MESSAGE);
